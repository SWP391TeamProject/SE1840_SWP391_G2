...
public interface AttachmentService {
    ...
    void deleteItemAttachment(int itemId, int attachmentId);
    void deleteBlogAttachment(int blogId, int attachmentId);
    void deleteAuctionAttachment(int auctionId, int attachmentId);
