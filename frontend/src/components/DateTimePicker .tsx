  ...
  return (
    <Popover open={open} onOpenChange={setOpen} aria-label="Date Time Picker">
      <PopoverTrigger asChild>
        <Button
          variant={'outline'}
          className={cn('min-w-[240px] justify-start text-left h-12', !props.value && 'text-muted-foreground')}
        >
        ...
        <Calendar
          ...
          footer={
            <TimeField
              ...
              hasTime={hasTime}
              onHasTimeChange={(newHasTime) => onChangeWrapper(dateToCalendarDateTime(props.value?.date!), newHasTime)}
