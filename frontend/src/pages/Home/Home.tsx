...
const CollectionCard: React.FC<CollectionCardProps> = ({ src, alt, collection, title, showAllText }) => (
    ...
    <article className="grow py-2.5 pr-6 pl-2.5 w-full bg-white rounded shadow-sm max-md:pr-5 max-md:mt-3 max-md:max-w-full">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <img
          ...
          src={src}
          alt={alt}
          className="flex flex-col w-[39%] max-md:ml-0 max-md:w-full grow shrink-0 max-w-full aspect-[0.76] max-md:mt-6"
        />
          ...
          <header className="flex flex-col max-md:mt-7">
            ...
            <div className="flex gap-3 mt-4">
              <div className="flex flex-col items-center text-sm leading-5 text-orange-500 whitespace-nowrap">
                ...
                <button className="justify-center self-stretch px-3 py-3.5 mt-6 bg-white rounded-2xl border border-orange-500 border-solid">
                  Details
                </button>
              </div>
  ...
  const auctionCards = [
    {
      ...
      detailsSrc1:
        'https://cdn.builder.io/api/v1/image/assets/TEMP/abf19eebc6a357c1d3ff283c1e6ecd2674c854422ec83bdbb8961e3924bd7094?apiKey=40cd77fa48c34fae9866559ef84b0f27&',
      detailsAlt1: 'Detail Image 1',
      detailsSrc2:
        'https://cdn.builder.io/api/v1/image/assets/TEMP/aa8c2adedd15e2b2e012b4cba46112077a8714c534cdaa3f26a548696f12acf8?apiKey=40cd77fa48c34fae9866559ef84b0f27&',
