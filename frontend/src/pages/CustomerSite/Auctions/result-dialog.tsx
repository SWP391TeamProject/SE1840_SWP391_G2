            ...
            <Dialog {...props}>
                ...
                <DialogContent className='w-full p-8'>
                    <div className='w-full h-[300px]'>
                        <img className=' absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2' src='https://cdn-icons-png.flaticon.com/128/6688/6688579.png' alt='placeholder' id="mystery-box" />
                        <motion.div 
                        ...
                        >
                            ...
                            <p className='col-span-1 text-center'>{currency.format(items?.reduce((a, b) => a + b.currentPrice, 0))}</p>
                        </motion.div>
                    </div>
                    {!totalRevealed && (
                        <Button onClick={() => revealItem(revealedItems.length)}>Reveal Next Item</Button>
                    )}
                    {totalRevealed && (
                        <Button onClick={() => { nav('/dashboard/orders') }}>View Orders</Button>
                    )}
                </DialogContent>
            </Dialog>
        </>
