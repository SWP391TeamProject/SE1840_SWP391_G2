          ...
          <Form {...form}>
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
              <FormField
                ...
                render={({field}) => (
                  <FormItem>
                    ...
                    <FormDescription>Enter the amount of balance to
                      deposit.</FormDescription>
                    <FormMessage/>
                  </FormItem>
                )}/>
              <Separator/>
              ...
              <Button className="w-full"
                      disabled={auth.user.balance - form.getValues().amount <= 0}>Submit</Button>
              <p className="text-sm text-muted-foreground">
                Your request will be manually processed. It may take up to 24
                hours. If the request is cancelled for any reason, your withdrawal
