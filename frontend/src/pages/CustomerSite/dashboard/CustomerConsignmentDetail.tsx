  ...
  useEffect(() => {
    switch (consignment.status) {
      case ConsignmentStatus.WAITING_STAFF:
        setCustConsignmentDetail(
          custConsignment.consignmentDetails.filter(
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        <div>
          ...
          <p className="mt-4 text-lg text-muted-foreground">{custConsignmentDetail?.description}</p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-base font-medium">
                {consignment.createDate ? new Date(consignment.createDate).toLocaleString() : ''}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-base font-medium">
                {consignment.updateDate ? new Date(consignment.updateDate).toLocaleString() : ''}
              </p>
            </div>
          </div>
