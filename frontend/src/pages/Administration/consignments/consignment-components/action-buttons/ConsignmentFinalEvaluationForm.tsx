...
} from "@/services/ConsignmentDetailService.tsx";
...
const ConsignmentFinalEvaluationForm: React.FC<ConsignmentFinalEvaluationFormProps> = ({
  ...
  return (
    auth.user.role === Roles.STAFF ?
      <AlertDialog>
        <AlertDialogTrigger>
          <Button variant="default" disabled={loading}>Send final
            evaluation</Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              The initial evaluation cannot be changed. A manager will review
              your evaluation. If it is accepted, the customer will take turn to
              respond to your evaluation. Otherwise, you might re-evaluate this
              consignment.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <Form {...form}>
