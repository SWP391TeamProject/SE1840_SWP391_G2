    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            The initial evaluation cannot be changed. The customer has the rights to cancel this consignment. If they
            accept, the customer will have to bring the jewelry to our office.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <Form {...form}>
