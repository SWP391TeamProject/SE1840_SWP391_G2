...
import {
  acceptStaffEvaluation,
  rejectStaffEvaluation,
...
const ManagerFinalEvaluationForm: React.FC<ManagerFinalEvaluationFormProps> = ({
                                                                                 consignment,
                                                                                 setConsignment
                                                                               }) => {
  ...
  const rejectEvaluation = async () => {
    ...
    setOpen(false);
    setLoading(true);
    toast.promise(rejectStaffEvaluation(
      consignment.consignmentId,
      auth.user.accountId, form.getValues().reason), {
      loading: 'Rejecting...',
      success: (res) => {
        setLoading(false);
        setConsignment(res.data);
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                One you have accepted, the customer will take turn to respond to
                the evaluation. They might choose to cancel the consignment.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <AlertDialog open={open}>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
              <AlertDialogDescription>
                The staff will have another opportunity to re-evaluate.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({field}) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Enter the reason for rejection" {...field} />
                      </FormControl>
                      <FormMessage/>
                    </FormItem>
                  )}
