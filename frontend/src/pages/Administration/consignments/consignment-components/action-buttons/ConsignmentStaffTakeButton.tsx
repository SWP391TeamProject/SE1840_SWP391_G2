...
const ConsignmentStaffTakeButton: React.FC<ConsignmentStaffTakeButtonProps> = ({
                                                                                 consignment,
                                                                                 setConsignment
                                                                               }) => {
  const auth = useAuth();
  ...
  return (
    auth.user.role === Roles.STAFF ?
      <AlertDialog>
        <AlertDialogTrigger>
          <Button variant="default" disabled={loading}>Take this
            consignment</Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. You must take this consignment and support
              the customer a long the way until this consignment is done.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
