...
interface itemsTableFloatingBarProps {
  table: Table<ReturnType<typeof getItems>>;
}

export function ItemsTableFloatingBar({ table }: itemsTableFloatingBarProps) {
