          ...
          <div className="flex flex-col w-full gap-3 p-3">
                    ...
                    {currentAuctionSession?.status !== AuctionSessionStatus.FINISHED &&
                      currentAuctionSession?.status !== AuctionSessionStatus.TERMINATED && (
                        <>
                          ...
                          <ConfirmationButton
                            onSuccess={handleInviteAll}
                            message={'Are you sure to Invite all users to this session?'}
                            title={'Confirmation'}
                            label={'Ok'}
                            description={'This action cannot be undone.'}
                            className="m-2"
            ...
            <div className="w-full flex flex-row gap-2">
              <div className="basis-8/12">
                <ItemsList
                  sessionItems={currentAuctionSession?.auctionItems}
                  sessionStatus={currentAuctionSession?.status}
                />
              </div>
