...
import AuctionSessionsTable
  from "@/pages/Administration/Auction-session/auction-session-data-table/auction-session-table.tsx";
        ...
        <TabsContent value="all">
          <Card x-chunk="dashboard-06-chunk-0">
            <CardHeader>
              ...
              <CardDescription>Manage auction sessions and view
                details.</CardDescription>
            </CardHeader>
            <CardContent>
              <AuctionSessionsTable
                auctionSessionPromise={auctionSessionPromise}/>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
