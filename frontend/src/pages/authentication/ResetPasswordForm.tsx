...
function ResetPasswordForm() {
  ...
  return (
    <Card className="login-form mx-auto min-w-[360px] w-1/3 mt-32 h-fit border drop-shadow-md rounded-xl">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardHeader className="">
            <CardTitle className="text-4xl text-center text-bold">Reset password</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-center justify-center">
                    ...
                    <FormDescription>Check your email inbox for a 6 digits reset code</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
