...
function UnactivatedWarning() {
  ...
  return (
    <Card className="w-3/6 h-3/4 mt-20 border drop-shadow-md rounded-xl" ref={UnactivatedWarning}>
      <div className="basis-full md:basis-1/2 w-full p-10">
        <h1 className="text-3xl mb-3">Activate your account</h1>
        <p>Hello {user.nickname}</p>
        <p>
          Please activate your account to proceed. Check your email for activation instructions or contact customer
