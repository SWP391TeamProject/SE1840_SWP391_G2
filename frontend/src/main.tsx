...
import { OrderCheckout } from '@/pages/CustomerSite/dashboard/orders/OrderCheckout.tsx';
                ...
                <BrowserRouter>
                  <Routes>
                    ...
                    <Route path="/" element={<CustomerLayout />}>
                      ...
                      <Route
                        element={
                          <PrivateRoute allowedRoles={[Roles.ADMIN, Roles.STAFF, Roles.MANAGER, Roles.MEMBER]} />
                        }
                      >
                        <Route path="create-consignment" element={<Consignment />}></Route>
                        ...
                        <Route path="/profile" element={<ProfileLayout />}>
                          ...
                          <Route path="preferences" element={<ProfilePreferences />}></Route>
                          <Route path="notification" element={<NotificationsList />}></Route>
                    ...
                    <Route element={<PrivateRoute allowedRoles={[Roles.ADMIN, Roles.STAFF, Roles.MANAGER]} />}>
                      <Route path="/admin" element={<Administration />}>
                        ...
                        <Route element={<PrivateRoute allowedRoles={[Roles.MANAGER, Roles.ADMIN]} />}>
                          ...
                          <Route path="payments/:id" element={<ItemDetail />}></Route>
